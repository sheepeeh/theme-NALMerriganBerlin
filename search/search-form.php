<form id="search-form" name="search-form" action="<?php echo url('/items/browse'); ?>" method="get">    <input type="text" name="search" id="query" value="" title="Search" placeholder="Search...">        
