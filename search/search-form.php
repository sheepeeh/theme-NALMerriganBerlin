<form id="search-form" name="search-form" action="/exhibits/merrigan/items/browse" method="get">    <input type="text" name="search" id="query" value="" title="Search" placeholder="Search...">        
