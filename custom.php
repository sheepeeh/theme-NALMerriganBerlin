...
function exhibit_builder_display_random_featured_exhibit_more_text()
{
    ...
    if ($featuredExhibit) {
       ...
       $html .= '<p>'. metadata($featuredExhibit, 'description', array('no_escape'=>true, 'snippet'=>750)).'</p>';
    } else {
...
//Starts a conditional statement that determines a search has been run
    if (isset($_SERVER['QUERY_STRING'])) {
        ...
        elseif (strpos($_SERVER['HTTP_REFERER'],'exhibits/show/know-your') != false) {
        ...
        elseif (strpos($_SERVER['HTTP_REFERER'],'exhibits/show/shaping-legislation') != false) {
